{...}: {
  flake.homeModules.hyprland-media = {
    ...
    wayland.windowManager.hyprland.settings = {
      ...
      bindeld = [
        # Volume
        ",XF86AudioRaiseVolume,Vol up,exec, wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+"
        ...
        ",XF86MonBrightnessDown,Brightness down,exec, brightnessctl -d intel_backlight set 5%-"
      ];
    };
  };
}
